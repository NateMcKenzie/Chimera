...
namespace Chimera
{
    public partial class certificateDisplay : Form
    {
        ...
        private void certPicture_MouseClick(object sender, MouseEventArgs e)
        {

            if(e.X > 81 && e.X < 321 && e.Y > 539 && e.Y < 775)
            {
                icon.Size = new System.Drawing.Size(20, 20);
                icon.Location = new Point(Width / 2 - 10, Height / 2 - 10 - certPicture.Top);
                icon.Visible = true;
                icon.BackgroundImage = Chimera.Properties.Resources.chimeraword;
