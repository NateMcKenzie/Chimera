            ...
            if (clickedButton.Name.Contains("1"))
            {
                switch (clickedButton.Name.Substring(0, clickedButton.Name.Length - 1))
                {
                    case "ecoAMPbutton":
                        ...
                        leftBottom = BasePair.createFromString(Globals.ecoAMPcutSite.Substring(0, Globals.ecoAMPcutSite.Length-3));
                        break;
                    case "bamAMPbutton":
                        leftCutSite = bamCutSite;
                        leftPlasmid = "bamAMP";
                        leftTop = BasePair.createFromString(Globals.bamAMPcutSite.Substring(0, 8));
                        leftBottom = BasePair.createFromString(Globals.bamAMPcutSite.Substring(0, Globals.bamAMPcutSite.Length - 3));
                        break;
                    case "ecoKANbutton":
                        leftCutSite = ecoCutSite;
                        leftPlasmid = "ecoKAN";
                        leftTop = BasePair.createFromString(Globals.ecoKANcutSite.Substring(0, 8));
                        leftBottom = BasePair.createFromString(Globals.ecoKANcutSite.Substring(0, Globals.ecoKANcutSite.Length - 3));
                        break;
                    case "bamKANbutton":
                        leftCutSite = bamCutSite;
                        leftPlasmid = "bamKAN";
                        leftTop = BasePair.createFromString(Globals.bamKANcutSite.Substring(0, 8));
                        leftBottom = BasePair.createFromString(Globals.bamKANcutSite.Substring(0, Globals.bamKANcutSite.Length - 3));
                        break;
                    case "ecoHumiraButton":
                        leftPlasmid = "ecoHumira";
                        leftCutSite = ecoCutSite;
                        leftTop = BasePair.createFromString(Globals.ecoHumiraCutSite.Substring(0, 8));
                        leftBottom = BasePair.createFromString(Globals.ecoHumiraCutSite.Substring(0, Globals.ecoHumiraCutSite.Length - 3));
                        break;
                    case "bamHumiraButton":
                        leftPlasmid = "bamHumira";
                        leftCutSite = bamCutSite;
                        leftTop = BasePair.createFromString(Globals.bamHumiraCutSite.Substring(0, 8));
                        leftBottom = BasePair.createFromString(Globals.bamHumiraCutSite.Substring(0, Globals.bamHumiraCutSite.Length - 3));
                        break;
                    case "ecoHumulinButton":
                        leftPlasmid = "ecoHumulin";
                        leftCutSite = ecoCutSite;
                        leftTop = BasePair.createFromString(Globals.ecoHumulinCutSite.Substring(0, 8));
                        leftBottom = BasePair.createFromString(Globals.ecoHumulinCutSite.Substring(0, Globals.ecoHumulinCutSite.Length - 3));
                        break;
                    case "bamHumulinButton":
                        leftPlasmid = "bamHumulin";
                        leftCutSite = bamCutSite;
                        leftTop = BasePair.createFromString(Globals.bamHumulinCutSite.Substring(0, 8));
                        leftBottom = BasePair.createFromString(Globals.bamHumulinCutSite.Substring(0, Globals.bamHumulinCutSite.Length - 3));
                        break;
            ...
            else if (clickedButton.Name.Contains("2"))
            {
                switch (clickedButton.Name.Substring(0, clickedButton.Name.Length - 1))
                {
                    case "ecoAMPbutton":
                        ...
                        rightBottom = BasePair.createFromString(Globals.ecoAMPcutSite.Substring(0, Globals.ecoAMPcutSite.Length - 3));
                        break;
                    case "bamAMPbutton":
                        rightCutSite = bamCutSite;
                        rightPlasmid = "bamAMP";
                        rightTop = BasePair.createFromString(Globals.bamAMPcutSite.Substring(0, 8));
                        rightBottom = BasePair.createFromString(Globals.bamAMPcutSite.Substring(0, Globals.bamAMPcutSite.Length - 3));
                        break;
                    case "ecoKANbutton":
                        rightCutSite = ecoCutSite;
                        rightPlasmid = "ecoKAN";
                        rightTop = BasePair.createFromString(Globals.ecoKANcutSite.Substring(0, 8));
                        rightBottom = BasePair.createFromString(Globals.ecoKANcutSite.Substring(0, Globals.ecoKANcutSite.Length - 3));
                        break;
                    case "bamKANbutton":
                        rightCutSite = bamCutSite;
                        rightPlasmid = "bamKAN";
                        rightTop = BasePair.createFromString(Globals.bamKANcutSite.Substring(0, 8));
                        rightBottom = BasePair.createFromString(Globals.bamKANcutSite.Substring(0, Globals.bamKANcutSite.Length - 3));
                        break;
                    case "ecoHumiraButton":
                        rightPlasmid = "ecoHumira";
                        rightCutSite = ecoCutSite;
                        rightTop = BasePair.createFromString(Globals.ecoHumiraCutSite.Substring(0, 8));
                        rightBottom = BasePair.createFromString(Globals.ecoHumiraCutSite.Substring(0, Globals.ecoHumiraCutSite.Length - 3));
                        break;
                    case "bamHumiraButton":
                        rightPlasmid = "bamHumira";
                        rightCutSite = bamCutSite;
                        rightTop = BasePair.createFromString(Globals.bamHumiraCutSite.Substring(0, 8));
                        rightBottom = BasePair.createFromString(Globals.bamHumiraCutSite.Substring(0, Globals.bamHumiraCutSite.Length - 3));
                        break;
                    case "ecoHumulinButton":
                        rightPlasmid = "ecoHumulin";
                        rightCutSite = ecoCutSite;
                        rightTop = BasePair.createFromString(Globals.ecoHumulinCutSite.Substring(0, 8));
                        rightBottom = BasePair.createFromString(Globals.ecoHumulinCutSite.Substring(0, Globals.ecoHumulinCutSite.Length - 3));
                        break;
                    case "bamHumulinButton":
                        rightPlasmid = "bamHumulin";
                        rightCutSite = bamCutSite;
                        rightTop = BasePair.createFromString(Globals.bamHumulinCutSite.Substring(0, 8));
                        rightBottom = BasePair.createFromString(Globals.bamHumulinCutSite.Substring(0, Globals.bamHumulinCutSite.Length - 3));
                        break;
